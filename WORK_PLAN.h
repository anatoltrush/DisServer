...
// TODO: --- 4 --- Redirection нагрузки (LoadBalancing) синхронизация? + СКРИПТ НА ЗАПОЛНЕНИЕ БАЗЫ ДАННЫХ
...
// TODO: --- 7 --- Кик по времени
// TODO: --- 8 --- PUSH-уведомления, отправка писем на почту (e-mail spam)
// TODO: --- 100 --- ЧАТЫ
// TODO: --- 500 --- защита от атак (проверка результатов перед выдачей, ограничения)
// TODO: --- 100500 --- SSL
// TODO: --- 100501 --- подумать о СТЭКЕ (подумать над ограничением на рекурсию при удалении комментариев)
...
// - Поставить проверку на касты
// - ПРОТЕСТИРОВАТЬ DELETE-функцию Image+comm+рекурсия
