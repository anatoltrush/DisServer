...
// - ПРОТЕСТИРОВАТЬ DELETE-функцию Image+comm+рекурсия ПЕРЕДЕЛАТЬ
// - Коммент: поставить заглушку (только в БД)
...
// --- ВТОРОСТЕПЕННЫЕ ---
// - Юзер: раздел проголосованные (сделать просто запрос), закладки(избранное)
